    ...
    : describe("Nft Marketplace Unit Tests", function () {
         ...
         /////////////
          ...
          describe("List Item", function () {
              ...
              it("Check if the NFT is already Listed", async function () {
              ...
              it ("Checks if price is above 0", async function () {
                const nftPrice = ethers.utils.parseEther("0")
                await expect(
                    nftMarketplace.listItem(basicNft.address, TOKEN_ID, nftPrice)
                ).to.be.revertedWith("PriceMustBeAboveZero")
              })
              it ("needs approval to list the item", async function () {
                //if it isnt equal to nftAddress it isnt approves
                //ethers.constants.AddressZero = 0x0000000..00 making it not the contract address
         ...
         describe("Cancel Listing", function() {
            ...
            it("emits an event when a listing is cancelled", async function () {
                await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
       ...
       describe ("Withdraw Proceeds", function () {
            it("reverts with an error if there are no proceeds", async function(){
